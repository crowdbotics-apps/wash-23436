...
admin.site.site_header = "Wash"
admin.site.site_title = "Wash Admin Portal"
admin.site.index_title = "Wash Admin"

# swagger
api_info = openapi.Info(
    title="Wash API",
    default_version="v1",
    description="API documentation for Wash App",
)
